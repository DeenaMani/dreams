                ...
                <div class="row align-items-center">
                    <div class="col-sm-5 col-xl-6">
                        <div class="page-title">
                            <h2 class="mb-1 font-weight-bold text-white">Course</h2>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                <div class="card ">
                    <div class="card-header row">
                        ...
                        <div class="col-lg-3">
                            <a href="{{url('admin/course/create')}}" class="btn btn-primary me-5" style="float:right;"> Add <i class="bx bx-plus"></i></a>
                        </div>
                    </div>                
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="row justify-content-center"> 
                                        <a href="{{ url('admin/course/'.$data->id.'/edit') }}" class=" btn btn-primary"><i class="fa fa-edit"></i> </a>
                                        <form action="{{ url('admin/course/'.$data->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
 ...
 @push('scripts')
   ...
   <script type="text/javascript">
     ...
     $(document).on("change",".toggle-class",function() {
         ...
         //alert(id);
         $.ajax({
             url: "{{URL('/')}}/admin/course/status/" + id + "/" +status ,
                 success: function(e) {
             }
         });
     });
