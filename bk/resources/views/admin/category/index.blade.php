                ...
                <div class="row align-items-center">
                    <div class="col-sm-5 col-xl-6">
                        <div class="page-title">
                            <h2 class="mb-1 font-weight-bold text-white">Category</h2>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                <div class="card ">
                    ...
                    <div>
                        ...
                        <div class="col-lg-3">
                            <a href="{{url('admin/category/create')}}" class="btn btn-primary me-5" style="float:right;"> Add <i class="bx bx-plus"></i></a>
                        </div>
                    </div>                
                            ...
                            @foreach ($results as $key => $data)
                                <tr>
                                    ...
                                    <td class="row justify-content-center"> 
                                        <a href="{{ url('admin/category/'.$data->id.'/edit') }}" class=" btn btn-primary"><i class="fa fa-edit"></i> </a>
 ...
 @push('scripts')
   ...
   <script type="text/javascript">
     ...
     $(document).on("change",".toggle-class",function() {
         ...
         //alert(id);
         $.ajax({
             url: "{{URL('/')}}/admin/category/status/" + id + "/" +status ,
                 success: function(e) {
             }
         });
     });
