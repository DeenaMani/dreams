...
Route::group(['middleware' => ['auth:web'] ],function(){
    ...
    Route::get('/attendance/absent',[AttendanceController::class,'absent']);
    Route::get('/attendance/get-absent',[AttendanceController::class,'getAbsentMembers'])->name('absent.members');
